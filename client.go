...
// APIClient manages communication with the lockally control plane API v0.1.0
...
type APIClient struct {
	...
	DistributionListsAPI *DistributionListsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.DistributionListsAPI = (*DistributionListsAPIService)(&c.common)
